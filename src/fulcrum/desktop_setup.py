...
STEWARD_HEARTBEAT_PROMPT = (
    ...
    "End after the thirty-second settled action, an idle deadline, or a protocol stop. Do "
...
STANDING = {
    "steward": {
        ...
        "prompt": (
            ...
            "immediately wait again. Process at most thirty-two returned actions in one turn. "
            "Do not choose priorities, invent prompts, retry uncertain effects, or poll "
            "tasks. End after the thirty-second settled action, an idle_deadline, an explicit "
