...
and four per-project slots; no reserve/helper-limit fields remain. Default role
models are Sol/high; explicit test/task overrides do not edit production defaults.
