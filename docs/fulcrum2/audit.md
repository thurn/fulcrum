...
| All operations user-initiated; no scheduled jobs | Design §1. No cron, recurring agents, interviews, calendar work, or automatic specialist passes. Operational polling, retry deadlines, and archive-once timers maintain existing submitted work. Future plans activate explicitly. |
